...
//         // float4 D_ = SAMPLE_TEXTURE2D_X_LOD(_BufferTex, s_linear_clamp_sampler, uv, 0);
//         // D_.a = 0;

//         // if (Luminance(D_.rgb) < luminanceThreshold)
//         // {
...
//         // return D_;
//         return float4(posInput.linearDepth, posInput.linearDepth, posInput.linearDepth, 1);
//     }
